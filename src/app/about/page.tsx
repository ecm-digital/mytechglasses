  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="max-w-3xl mx-auto mb-16">
        <h2 className="text-2xl font-bold mb-6 text-blue-600">Nasza historia</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
        <div className="bg-white p-8 rounded-lg shadow-md">
          <h2 className="text-2xl font-bold mb-6 text-blue-600">Nasza misja</h2>
          <p className="text-gray-600">
        ...
        <div className="bg-white p-8 rounded-lg shadow-md">
          <h2 className="text-2xl font-bold mb-6 text-blue-600">Nasza wizja</h2>
          <p className="text-gray-600">
      ...
      {/* Values */}
      <div className="mb-16">
        <h2 className="text-2xl font-bold mb-8 text-center text-blue-600">Nasze wartości</h2>
      ...
      {/* Team */}
      <div>
        <h2 className="text-2xl font-bold mb-8 text-center text-blue-600">Nasz zespół</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="text-center">
            <div className="h-40 w-40 rounded-full bg-gray-200 mx-auto mb-4 flex items-center justify-center">
              <span className="text-2xl font-bold text-blue-600">MN</span>
            </div>
          ...
          <div className="text-center">
            <div className="h-40 w-40 rounded-full bg-gray-200 mx-auto mb-4 flex items-center justify-center">
              <span className="text-2xl font-bold text-blue-600">PW</span>
            </div>
